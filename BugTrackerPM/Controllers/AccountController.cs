    ...
    public class AccountController : Controller
    {
       ...
       // [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { DisplayName = model.FirstName + ' ' + model.LastName, Email = model.Email, FirstName= model.FirstName, LastName = model.LastName, UserName= model.Email };
